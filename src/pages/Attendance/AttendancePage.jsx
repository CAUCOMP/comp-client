...
const AttendancePage = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center pt-20 gap-3 relative overflow-hidden">
      ...
      {/* 출석 api 연결하기 */}
      <button className="w-[200px] h-[50px] border border-blue-400/20 text-blue-200 font-semibold rounded-full hover:bg-blue-400/10 hover:border-blue-400/10 hover:drop-shadow-[0_0_20px_rgba(96,165,250,0.4)] transition-all flex items-center justify-center gap-2">
        <FiCheckCircle />
        출석하기
      </button>
